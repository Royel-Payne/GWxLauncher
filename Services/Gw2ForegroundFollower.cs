...
{
    /// <summary>
    /// GW2-only: polls the active (foreground) window and selects the matching profile
    /// if the process ID is tracked by Gw2InstanceTracker.
    /// Does not steal focus or bring the launcher to front.
    /// Mirrors Gw1ForegroundFollower functionality.
    /// </summary>
    internal sealed class Gw2ForegroundFollower : IDisposable
    {
        private readonly Gw2InstanceTracker _tracker;
        ...
        public Gw2ForegroundFollower(
            Gw2InstanceTracker tracker,
